...
from navsim.agents.rwkv7_tf.rwkv_model import RWKVModel
from navsim.agents.rwkv7_tf.rwkv_callback import RWKVCallback
from navsim.agents.rwkv7_tf.rwkv_loss import RWKV_loss
from navsim.agents.rwkv7_tf.rwkv_features import RWKVFeatureBuilder, RWKVTargetBuilder
...
class RWKVAgent(AbstractAgent):
    ...
    def forward(self, features: Dict[str, torch.Tensor]) -> Dict[str, torch.Tensor]:
        ...
        for k, v in features.items():
            features[k] = v.cuda()
        return self._rwkv_model(features)
