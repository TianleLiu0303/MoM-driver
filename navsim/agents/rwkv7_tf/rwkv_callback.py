...
class RWKVCallback(pl.Callback):
    """Visualization Callback for RWKV during training."""
    ...
    def _visualize_model(
        ...
        """
        Create tile of input-output visualizations for RWKV.
        ...
        """
        camera = features["camera_feature"][:, -1].permute(0, 2, 3, 1).numpy()
...
def semantic_map_to_rgb(semantic_map: npt.NDArray[np.int64], config: RWKVConfig) -> npt.NDArray[np.uint8]:
    """
