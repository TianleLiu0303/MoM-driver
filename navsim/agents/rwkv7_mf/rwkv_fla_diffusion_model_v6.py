...
from navsim.agents.rwkv_block.rwkv7_block_fla import RWKV7Block, RWKV7_DoubleSelfAttnBlock
...
class RWKVModel(nn.Module):
    ...
    def forward(
        ...
        status_feature: torch.Tensor = features["status_feature"] # (B, T, _)
        ...
        fused_status, _, _, _ = self._status_rwkv(status_encoding)
        keyval_status = fused_status[:, -1:, :] + self._status_embedding.weight[None, ...]
