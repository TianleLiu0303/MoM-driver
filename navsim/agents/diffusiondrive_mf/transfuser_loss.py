...
def transfuser_loss(
    ...
    weighted_trajectory_loss = config.trajectory_weight * trajectory_loss
    ...
    loss = weighted_trajectory_loss + weighted_agent_class_loss + weighted_agent_box_loss + weighted_bev_semantic_loss

    return loss, weighted_trajectory_loss, weighted_agent_class_loss, weighted_agent_box_loss, weighted_bev_semantic_loss
