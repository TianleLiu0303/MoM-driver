...
from navsim.agents.diffusiondrive_mf.transfuser_diffusion_model import TransfuserModel
from navsim.agents.diffusiondrive_mf.transfuser_callback import TransfuserCallback
from navsim.agents.diffusiondrive_mf.transfuser_loss import transfuser_loss
from navsim.agents.diffusiondrive_mf.transfuser_features import TransfuserFeatureBuilder, TransfuserTargetBuilder
from navsim.common.dataclasses import SensorConfig
from navsim.planning.training.abstract_feature_target_builder import AbstractFeatureBuilder, AbstractTargetBuilder


class DiffusionDrive(AbstractAgent):
    ...
    def forward(self, features: Dict[str, torch.Tensor], targets: Dict[str, torch.Tensor]=None, use_cache: bool=False) -> Dict[str, torch.Tensor]:
        """Inherited, see superclass."""
        return self._transfuser_model(features, targets, use_cache)
