...
import numpy as np
from navsim.agents.score_module.pdm_scorer_training import PDMScorerConfig, PDMScorer
...
def get_sub_score(metric_cache, poses, test):
    ...
    # driving_direction_compliance metric not available in current version, use placeholder
    driving_direction_compliance = np.ones_like(drivable_area_compliance)
