...
# from navsim.agents.rwkv7_mixed.rwkv_model import RWKVModel
# from navsim.agents.rwkv7_mixed.rwkv_fla_model import RWKVFLAModel
from navsim.agents.rwkv7_mixed.rwkv_fla_diffusion_model import RWKVModel
from navsim.agents.rwkv7_mixed.rwkv_callback import RWKVCallback
from navsim.agents.rwkv7_mixed.rwkv_loss import RWKV_loss
from navsim.agents.rwkv7_mixed.rwkv_features import RWKVFeatureBuilder, RWKVTargetBuilder
...
class RWKVAgent(AbstractAgent):
    ...
    def compute_loss(
        ...
        """Inherited, see superclass."""
        return RWKV_loss(targets, predictions, self._config)
    ...
    def get_training_callbacks(self) -> List[pl.Callback]:
        ...
        return [RWKVCallback(self._config), best_model_checkpoint, every_10_epoch_checkpoint]
