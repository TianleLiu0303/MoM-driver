...
from navsim.agents.transfuser_mf.transfuser_backbone import TransfuserBackbone
from navsim.agents.transfuser_mf.transfuser_features import BoundingBox2DIndex
...
class TransfuserModel(nn.Module):
    ...
    def forward(self, features: Dict[str, torch.Tensor], use_cache: bool = False) -> Dict[str, torch.Tensor]:
