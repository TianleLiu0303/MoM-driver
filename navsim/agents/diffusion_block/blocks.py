...
class GridSampleCrossBEVAttention(nn.Module):
    def __init__(self, embed_dims, num_heads, num_levels=1, in_bev_dims=64, out_dims=256, num_points=8, config=None):
        super().__init__()  
        ...
        self.value_proj = nn.Sequential(
            nn.Conv2d(in_bev_dims, out_dims, kernel_size=(3, 3), stride=(1, 1), padding=1, bias=True),
    ...
    def forward(self, queries, traj_points, bev_feature, spatial_shape):
        ...
        # Sample features -> [bs, C, num_queries, num_points]
